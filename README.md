...
```
.
├── data/                       # Generated by running generate_dataset.ipynb
│   ├── baseline/
...
├── results/                    # Generated after running the notebooks
│   ├── unigram/                # Unigram .pkl files (one per model)
│   ├── honorific/
│   │   ├── data/               # CSV results
│   │   ├── SLOR/               # SLOR violin plots (PNG)
│   │   └── Surprisal/          # Mean Surprisal violin plots (PNG)
│   └── case_marking/
│       ├── data/
│       ├── SLOR/
│       └── Surprisal/
